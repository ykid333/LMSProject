                                    ...
                                    <div class="card-content table-responsive table-full-width">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr class="success">
                                                    <td>1</td>
                                                    <td><a href="curriculum_TrainingLogView">2018.04.27</a></td>
                                                    <td>홍길동</td>
                                                    <td>30 명</td>
                                                    <td class="text-info">28 명</td>
                                                    <td class="text-danger">2 명</td>
                                                    <td class="text-primary">3 명</td>
                                                    <td class="text-success">0 명</td>
                                                </tr>
                                                <tr>
                                                    <td>1</td>
                                                    <td><a href="#">2018.04.27</a></td>
                                                    <td>홍길동</td>
                                                    <td>30 명</td>
                                                    <td class="text-info">28 명</td>
                                                    <td class="text-danger">2 명</td>
