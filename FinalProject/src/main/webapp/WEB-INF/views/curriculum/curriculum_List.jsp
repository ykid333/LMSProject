                        ...
                        <div class="col-md-12">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <h4 class="card-title">진행 중인 과정</h4>
                                    <div class="card-content table-responsive table-full-width">
                                        <table class="table table-hover">
                                            <thead>
                                                ...
                                                <th>교육기간</th>
                                                <th>담임</th>
                                                <th class="text-success">교육중 인원</th>
                                            </thead>
                                            <tbody>
                                                <tr class="success">
                                                    <td>1</td>
                                                    <td><a href="curriculum_TraineeList">IoT 센서 데이터를 활용한 수치 예보 시각화 과정</a></td>
                                                ...
                                                <tr>
                                                    <td>2</td>
                                                    <td>반응형 Web & App 콘텐츠 개발자 양성과정</td>
                                                    <td>2018.04.26~2018.10.26</td>
                                                    <td>고기경</td>
                                                    <td>30</td>
                                                </tr>
                                                ...
                                                <tr class="danger">
                                                    <td>5</td>
                                                    <td>IoT 센서 기반 응용 소프트웨어 엔지니어 양성과정</td>
                                                    <td>2018.04.26~2018.10.26</td>
                                                    <td>배여랑</td>
                                                    <td>30</td>
                                                </tr>
